...
export type UPS_DATA = Map<string, number | string>;

export function parseUpsData(data: string): UPS_DATA {
...
export function isDifferent(dataNew: UPS_DATA, dataOld: UPS_DATA): boolean {
